...
titl = tk.Label(
    window, text="Smart Security system !!", bg="black", fg="green", font=("arial", 27),
)
titl.place(x=525, y=12)

a = tk.Label(
    window,
    text="Welcome to the Entry Exit System through \nFace Recognition Based",
    bg="black",
    fg="yellow",
    bd=10,
    font=("arial", 35),
...
def TakeImageUI():
    ImageUI = Tk()
    ImageUI.title("Take Person Image..")
